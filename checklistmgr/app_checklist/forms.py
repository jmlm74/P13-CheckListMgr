...
class MaterialChecklistForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        super(MaterialChecklistForm, self).__init__(*args, **kwargs)
...
class ManagerChecklistForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        super(ManagerChecklistForm, self).__init__(*args, **kwargs)
...
class ChklstChecklistForm(forms.Form):
    chk_title = forms.CharField(max_length=80,
                                label='Check-List title',
                                widget=forms.TextInput(attrs={'readonly': 'readonly'}))
    chk_save = forms.CharField(max_length=1500, label='chk_save')

    class Meta:
        fields = ['chk_title', 'chk_save']

    def __init__(self, *args, **kwargs):
        super(ChklstChecklistForm, self).__init__(*args, **kwargs)
